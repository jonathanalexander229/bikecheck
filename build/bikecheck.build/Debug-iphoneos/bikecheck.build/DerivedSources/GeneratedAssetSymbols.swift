...
extension ImageResource {
    ...
    static let bikeCheckLogo = ImageResource(name: "BikeCheckLogo", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "BikeCheckLogo" asset catalog image.
    static var bikeCheckLogo: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .bikeCheckLogo)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "BikeCheckLogo" asset catalog image.
    static var bikeCheckLogo: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .bikeCheckLogo)
#else
        .init()
